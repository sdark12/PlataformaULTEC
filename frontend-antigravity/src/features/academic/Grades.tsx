    ...
    return (
        <div className="max-w-7xl mx-auto pb-12">
            ...
            <div className="flex space-x-6 mb-8 border-b border-slate-200">
                <button
                    className={`pb-3 text-sm font-semibold border-b-2 flex items-center gap-2 transition-colors ${activeTab === 'general' ? 'border-blue-600 text-blue-600' : 'border-transparent text-slate-500 hover:text-slate-700'}`}
                    onClick={() => setActiveTab('general')}
                >
                    <AlignJustify className="w-4 h-4" /> Calificación General Bimestral
                </button>
                <button
                    className={`pb-3 text-sm font-semibold border-b-2 flex items-center gap-2 transition-colors ${activeTab === 'detailed' ? 'border-blue-600 text-blue-600' : 'border-transparent text-slate-500 hover:text-slate-700'}`}
